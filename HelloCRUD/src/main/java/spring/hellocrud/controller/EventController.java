package spring.hellocrud.controller;
...
import spring.hellocrud.service.EventService;
...
public class EventController {
    ...
    public String addEvent(Model model, @ModelAttribute("event") Event event) {
        ...
        model.addAttribute("errorMsg", "Event Name & City and valid Price are required!");
        return "addEvent";
    }
